  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950 flex flex-col items-center justify-center px-4">
      <motion.div
        ...
        className="max-w-md w-full mx-auto py-16 px-6 sm:px-10 text-center"
      >
        {/* Success Icon */}
        <motion.div
        ...
        >
          <h1 className="text-2xl font-medium mb-3 text-zinc-900 dark:text-white">
            Submission received
          </h1>
          ...
          <div className="mt-8">
            <a 
              href="/"
              className="inline-flex items-center justify-center rounded-md px-6 py-2.5 text-sm font-medium text-white bg-zinc-800 hover:bg-zinc-700 dark:bg-zinc-200 dark:text-zinc-900 dark:hover:bg-zinc-300 transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-500 focus:ring-offset-2 dark:focus:ring-offset-zinc-900"
            >
              Return to website
            </a>
          </div>
        ...
        >
          ...
          >
            <span className="text-xs text-zinc-500 dark:text-zinc-400 mb-2">
              Powered by <span className="text-blue-500 dark:text-blue-400 font-medium">Mantlz</span>
            </span>
            <Logo size={24} />
          </a>
        </motion.div>
