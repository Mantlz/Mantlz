                ...
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3 sm:space-y-4">
                    ...
                    <div className="rounded-lg bg-zinc-50 border border-blue-200 p-3 sm:p-4 dark:bg-zinc-900 dark:border-blue-100">
                      <div className="flex gap-2 sm:gap-3">
                        <Info className="h-4 w-4 text-blue-500 dark:text-amber-500 flex-shrink-0 mt-0.5" />
                        <div>
                          <p className="text-xs font-medium text-blue-800 dark:text-blue-300">
                            Resend API Key Required
                          </p>
                          <p className="text-xs text-blue-700 dark:text-amber-500 mt-1">
                            Add your Resend API key to enable email notifications.{" "}
                            <a
                              href="https://resend.com/signup"
                              target="_blank"
                              rel="noopener noreferrer"
                              className="text-amber-500 dark:text-blue-300 underline underline-offset-4"
                            >
                              Get API key
                            </a>
                          </p>
