...
export default function AdvancedFeatureGrid() {
    return (
        <section className="py-16 md:py-32">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <h1 className="text-4xl md:text-5xl font-bold tracking-tight">Advanced features for power users</h1>
                    <p className="mt-4 text-lg md:text-xl text-muted-foreground">Take your form management to the next level with advanced tools</p>
                </div>
