    ...
    <footer className="w-full border-t border-neutral-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 text-neutral-700 dark:text-neutral-300 py-12">
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center md:items-start">
            <h3 className="text-lg font-semibold text-neutral-900 dark:text-neutral-50 mb-4 ">Connect</h3>
        ...
        <div className="mt-8 text-center text-sm text-neutral-500 dark:text-neutral-400 pt-6">
