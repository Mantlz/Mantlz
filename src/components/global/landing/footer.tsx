      ...
      <Container className="relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <p className="text-sm text-center md:text-left mb-6 text-gray-600 dark:text-zinc-300 leading-relaxed">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <nav className="flex flex-col items-center md:items-start space-y-4">
              <a
                ...
                className="text-gray-600 hover:text-gray-900 dark:text-zinc-300 dark:hover:text-white transition-all duration-200 flex items-center group p-2 rounded-lg hover:bg-gradient-to-r hover:from-gray-100/50 hover:to-white/50 dark:hover:from-zinc-800/50 dark:hover:to-zinc-700/50"
              >
                <Mail className="h-4 w-4 mr-3 text-zinc-600 group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors" />
              ...
              <a
                ...
                className="text-gray-600 hover:text-gray-900 dark:text-zinc-300 dark:hover:text-white transition-all duration-200 flex items-center group p-2 rounded-lg hover:bg-gradient-to-r hover:from-gray-100/50 hover:to-white/50 dark:hover:from-zinc-800/50 dark:hover:to-zinc-700/50"
              >
                <ExternalLink className="h-4 w-4 mr-3 text-zinc-600 group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors" />
        ...
        <div className="mt-12 pt-6 border-t border-gray-200/50 dark:border-zinc-700/50 text-center">
          <p className="text-sm text-zinc-600 dark:text-zinc-600 font-medium">
