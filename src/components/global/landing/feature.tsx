  ...
  return (
    <section className="py-24 relative">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 right-0 w-1/2 h-1/2 bg-zinc-100/30 dark:bg-zinc-800/20 rounded-full blur-3xl transform -translate-y-1/4 translate-x-1/4"></div>
        <div className="absolute bottom-0 left-0 w-1/3 h-1/2 bg-zinc-100/30 dark:bg-zinc-800/20 rounded-full blur-3xl transform translate-y-1/4 -translate-x-1/3"></div>
      </div>
      
      <div className="relative z-10 text-center mb-20">
        <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-zinc-700 to-zinc-900 dark:from-zinc-200 dark:to-zinc-400 bg-clip-text text-transparent">Everything you need for form management</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-6xl mx-auto px-4">
        ...
        <div className="group bg-white dark:bg-zinc-800/50 backdrop-blur rounded-lg border-2 border-black dark:border-zinc-600 p-8 md:col-span-2 md:row-span-2 flex flex-col h-full relative overflow-hidden transform-gpu translate-y-[-4px] translate-x-[-4px] hover:translate-y-[-8px] hover:translate-x-[-8px] transition-all duration-300 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.5)] hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[8px_8px_0px_0px_rgba(255,255,255,0.5)]">
            ...
            <div className="relative w-full h-full flex items-center justify-center group-hover:scale-105 transition-transform duration-500">
              <div className="absolute top-4 left-4 bg-white dark:bg-zinc-700 p-5 rounded-lg shadow-lg flex items-center space-x-3 group-hover:-translate-y-1 transition-transform">
                ...
                <div className="space-y-2">
                  <div className="h-3 w-32 bg-zinc-100 dark:bg-zinc-600 rounded-lg"></div>
                  <div className="h-3 w-24 bg-zinc-100 dark:bg-zinc-600 rounded-lg"></div>
                </div>
              </div>
              <div className="absolute bottom-0 right-0 bg-white dark:bg-zinc-700 p-5 rounded-lg shadow-lg group-hover:-translate-y-2 transition-transform duration-300 delay-100">
                <div className="space-y-3">
                  <div className="h-3 w-48 bg-zinc-100 dark:bg-zinc-600 rounded-lg"></div>
                  <div className="h-3 w-32 bg-zinc-100 dark:bg-zinc-600 rounded-lg"></div>
                  <div className="h-3 w-40 bg-zinc-100 dark:bg-zinc-600 rounded-lg"></div>
                </div>
              </div>
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-zinc-800 dark:bg-zinc-600 text-white dark:text-zinc-100 p-3 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-200 font-medium">
          ...
          <div className="mt-auto">
            <div className="flex items-center mb-3">
              <Palette className="h-5 w-5 text-zinc-600 dark:text-zinc-400 mr-2" />
        ...
        <div className="group bg-white dark:bg-zinc-800/50 backdrop-blur rounded-lg border-2 border-black dark:border-zinc-600 p-6 md:col-span-2 flex flex-col relative overflow-hidden transform-gpu translate-y-[-4px] translate-x-[-4px] hover:translate-y-[-8px] hover:translate-x-[-8px] transition-all duration-300 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.5)] hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[8px_8px_0px_0px_rgba(255,255,255,0.5)]">
          <div className="absolute -top-16 -right-16 h-32 w-32 bg-zinc-500/10 rounded-lg blur-2xl group-hover:bg-zinc-500/20 transition-all duration-500" />
          
          <div className="mb-4 flex items-center justify-start">
            <Code className="h-10 w-10 text-zinc-600 dark:text-zinc-400 mr-3" />
        ...
        <div className="group bg-white dark:bg-zinc-800/50 backdrop-blur rounded-lg border-2 border-black dark:border-zinc-600 p-6 md:col-span-2 flex flex-col relative overflow-hidden transform-gpu translate-y-[-4px] translate-x-[-4px] hover:translate-y-[-8px] hover:translate-x-[-8px] transition-all duration-300 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.5)] hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[8px_8px_0px_0px_rgba(255,255,255,0.5)]">
          ...
          <div className="mb-3 flex items-center justify-between">
            <div className="flex items-center">
              <BarChart className="h-10 w-10 text-zinc-600 dark:text-zinc-400 mr-3" />
              <h3 className="text-xl font-bold text-zinc-800 dark:text-white">Form Analytics</h3>
            </div>
            <div className="text-xs font-medium text-zinc-800 dark:text-zinc-300 bg-zinc-100 dark:bg-zinc-700 py-1 px-2 rounded-lg">
              2023
            </div>
          </div>
          ...
          <div className="relative h-40 flex flex-col">
            ...
            <div className="flex-1 flex items-end space-x-2 pt-2 px-1">
              <div className="group-hover:-translate-y-1 transition-transform duration-300 w-full h-full flex flex-col items-center justify-end">
                <div className="bg-zinc-100 dark:bg-zinc-700 w-full rounded-t-lg" style={{height: '30%'}}></div>
              ...
              <div className="group-hover:-translate-y-2 transition-transform duration-300 delay-75 w-full h-full flex flex-col items-center justify-end">
                <div className="bg-zinc-200 dark:bg-zinc-600 w-full rounded-t-lg" style={{height: '45%'}}></div>
              ...
              <div className="group-hover:-translate-y-3 transition-transform duration-300 delay-150 w-full h-full flex flex-col items-center justify-end">
                <div className="bg-zinc-300 dark:bg-zinc-500 w-full rounded-t-lg" style={{height: '60%'}}></div>
              ...
              <div className="group-hover:-translate-y-4 transition-transform duration-300 delay-200 w-full h-full flex flex-col items-center justify-end">
                <div className="bg-zinc-400 dark:bg-zinc-400 w-full rounded-t-lg" style={{height: '40%'}}></div>
              ...
              <div className="group-hover:-translate-y-3 transition-transform duration-300 delay-100 w-full h-full flex flex-col items-center justify-end">
                <div className="bg-zinc-500 dark:bg-zinc-500 w-full rounded-t-lg" style={{height: '55%'}}></div>
              ...
              <div className="group-hover:-translate-y-5 transition-transform duration-300 delay-300 w-full h-full flex flex-col items-center justify-end">
                <div className="bg-zinc-600 dark:bg-zinc-400 w-full rounded-t-lg" style={{height: '70%'}}></div>
                <div className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">Jun</div>
              </div>
              <div className="group-hover:-translate-y-5 transition-transform duration-300 delay-300 w-full h-full flex flex-col items-center justify-end">
                <div className="bg-zinc-700 dark:bg-zinc-300 w-full rounded-t-lg" style={{height: '80%'}}></div>
