  ...
  return (
    <Card className="mx-auto mb-4 max-w-xl w-full border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-sm">
      <CardHeader className="pb-2 pt-3 px-4 flex flex-row items-start justify-between space-y-0">
        ...
        <Badge className="bg-orange-100 text-orange-800 dark:bg-amber-700/30 dark:text-orange-200 whitespace-nowrap">
        ...
        <div className="grid gap-2 p-2 max-w-lg">
          <div className="flex items-center gap-3 bg-zinc-100 dark:bg-zinc-950 px-2 py-2 rounded-lg border border-zinc-200 dark:border-zinc-800 shadow-sm">
            ...
            <div className="flex flex-1 items-center justify-between gap-2">
              ...
              <span className="text-xs text-zinc-500 dark:text-zinc-400  whitespace-nowrap">
                {(usageData.usage?.forms.used || 0).toLocaleString()}/{currentQuota.maxForms.toLocaleString()} → {nextQuota.maxForms.toLocaleString()}
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 bg-zinc-100 dark:bg-zinc-950 px-2 py-2 rounded-lg border border-zinc-200 dark:border-zinc-800 shadow-sm">
            ...
            <div className="flex flex-1 items-center justify-between gap-2">
              ...
              <span className="text-xs text-zinc-500 dark:text-zinc-400 whitespace-nowrap">
                {(usageData.usage?.submissions.used || 0).toLocaleString()}/{currentQuota.maxSubmissionsPerMonth.toLocaleString()} → {nextQuota.maxSubmissionsPerMonth.toLocaleString()}
              </span>
            </div>
          </div>
