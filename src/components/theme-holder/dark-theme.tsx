...
export const DarkMode = () => {
  return (
    <svg
      ...
      <rect x="44" y="67" width="61" height="17" rx="3" fill="#2A2A35" />
      <rect x="44" y="88" width="61" height="17" rx="3" fill="#2A2A35" />
      <rect x="44" y="110" width="61" height="17" rx="3" fill="#2A2A35" />
      <rect x="44" y="132" width="61" height="17" rx="3" fill="#2A2A35" />
      <rect x="119" y="67" width="125" height="126" rx="4" fill="#2A2A35" />
      <rect x="137" width="145" height="193" fill="#121218" />
      <circle cx="45.5" cy="39.5" r="4.5" fill="#FF6F6F" />
      <circle cx="58.5" cy="39.5" r="4.5" fill="#FFF500" />
      <circle cx="71.5" cy="39.5" r="4.5" fill="#9AFF76" />
      <rect x="44" y="67" width="61" height="17" rx="3" fill="#2A2A35" />
      ...
      <path
        ...
        fill="#2A2A35"
      />
      <rect x="128" y="123" width="111" height="11" rx="3" fill="#2A2A35" />
