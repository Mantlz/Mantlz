      ...
      <div className="p-3 border-b border-zinc-200 dark:border-zinc-800 flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="h-8 gap-1 cursor-pointer rounded-lg bg-white/80 dark:bg-zinc-900/80 text-gray-700 dark:text-gray-300 border border-zinc-200 dark:border-zinc-700 backdrop-blur shadow-sm flex items-center px-3">
            ...
            <span className="text-sm text-zinc-500">Date Range</span>
          </div>
        </div>
      </div>
            ...
            {Array.from({ length: 5 }).map((_, index) => (
              ...
              >
                ...
                <TableCell className="py-3">
                  <div className="flex items-center gap-2">
                    <Mail className="h-3.5 w-3.5 text-zinc-500 dark:text-zinc-500" />
                ...
                <TableCell className="py-3">
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="flex items-center gap-1">
                      <MapPin className="h-3 w-3 text-zinc-500 dark:text-zinc-500" />
                ...
                {isPremium && (
                  <TableCell className="py-3 hidden md:table-cell">
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="flex items-center gap-1">
                        <Calendar className="h-3 w-3 text-zinc-500 dark:text-zinc-500" />
                ...
                <TableCell className="py-3">
                  <div className="flex items-center gap-1">
                    <Calendar className="h-3.5 w-3.5 text-zinc-500 dark:text-zinc-500" />
