  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        ...
        >
          <CalendarIcon className="mr-2 h-4 w-4 text-gray-600 dark:text-zinc-500" />
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-800 shadow-sm">
          <Calendar
            ...
            className={cn(
              ...
              "[&_.rdp-head_row]:flex",
              "[&_.rdp-head_cell]:text-zinc-500 [&_.rdp-head_cell]:rounded-lg [&_.rdp-head_cell]:w-8 [&_.rdp-head_cell]:font-normal [&_.rdp-head_cell]:text-[0.8rem]",
