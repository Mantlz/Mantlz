...
export function SearchButton({ onClick }: SearchButtonProps) {
  ...
  return (
    <Button
      variant="outline"
      onClick={onClick}
      className="h-9 gap-2 cursor-pointer rounded-lg bg-white/80 dark:bg-zinc-900/80 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-gray-700 dark:text-gray-300 border border-zinc-200 dark:border-zinc-700 backdrop-blur"
    >
