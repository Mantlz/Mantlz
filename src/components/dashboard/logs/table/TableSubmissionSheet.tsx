                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      ...
                      {isPremium ? (
                        ...
                        <div className="p-3 sm:p-4 border border-zinc-200 dark:border-zinc-800/50 rounded-lg bg-background dark:bg-background opacity-50 relative">
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {Object.entries(submission.data)
                        ...
                        <div
                          key={key}
                          className="p-3 sm:p-4 border border-zinc-200 dark:border-zinc-800/50 rounded-lg bg-background dark:bg-background"
                        >
                          <div className="flex items-center justify-between mb-2">
                            <div className="flex items-center gap-2">
                ...
                {submission.data && typeof submission.data === 'object' && '_meta' in submission.data && (
                  <div>
                    ...
                    {isPremium ? (
                      ...
                      <div className="p-4 border border-zinc-200 dark:border-zinc-800/50 rounded-lg bg-background dark:bg-background opacity-75">
