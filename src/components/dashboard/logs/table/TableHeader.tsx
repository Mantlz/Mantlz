...
export function TableHeader({ 
  ...
  return (
    <div className="relative overflow-hidden bg-background dark:bg-background rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-sm">
      ...
      <div className="relative p-6 lg:p-8">
        <div className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div className="bg-background dark:bg-background rounded-xl p-4 border border-zinc-200 dark:border-zinc-700 hover:border-zinc-300 dark:hover:border-zinc-600 transition-all duration-200">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-black/5 dark:bg-white/5 flex items-center justify-center">
