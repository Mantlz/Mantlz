...
import { LogsTableHeaderSkeleton, FormsGridSkeleton, StatsGridSkeleton } from "@/components/skeletons"
                ...
                <div className="grid grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <div className="bg-white dark:bg-zinc-800/50 rounded-xl p-4 sm:p-5 border border-gray-100 dark:border-gray-800/50 hover:border-gray-200 dark:hover:border-gray-700 transition-all duration-200">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-900 dark:text-white">{formsData.forms.reduce((acc, form) => acc + form.submissionCount, 0)}</p>
                    ...
                    <div className="mt-2 h-1 w-full bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden">
                      <div 
                        className="h-full bg-black dark:bg-white rounded-full transition-all duration-500"
                        style={{ width: `${Math.min((formsData.forms.reduce((acc, form) => acc + form.submissionCount, 0) / 100) * 100, 100)}%` }}
                      />
                    </div>
                  </div>
                </div>
