        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 self-start sm:self-auto mt-2 sm:mt-0">
            {/* <Button 
              variant="outline" 
              size="sm" 
              className="border-gray-300 dark:border-zinc-700 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-zinc-800 rounded-sm transition-all duration-200"
              onClick={onBack}
            >
