...
export function FormHeader({
  ...
  return (
    <div className="relative overflow-hiddenrounded-xl sm:rounded-2xl border border-zinc-200 dark:border-zinc-800">
      ...
      <div className="relative p-3 xs:p-4 sm:p-6 lg:p-8">
        <div className="flex flex-col gap-4 sm:gap-6">
            ...
            <div className="flex flex-wrap items-center gap-2 mt-2 sm:mt-0">
              <Sheet>
                <SheetTrigger asChild>
                  <Button
                    variant="outline"
                    size="sm"
                    className="flex items-center gap-1 xs:gap-2 cursor-pointer bg-zinc-50 dark:bg-zinc-800 px-2 xs:px-3 sm:px-4 py-1.5 xs:py-2 rounded-lg border border-zinc-200 dark:border-zinc-700 hover:shadow-md transition-shadow duration-200 h-8 xs:h-9"
                  >
                ...
                <SheetContent side="right" className="w-[85vw] sm:w-[65vw] md:w-[55vw] lg:w-[45vw] xl:w-[35vw] p-0 max-w-screen-md h-screen overflow-hidden">
                  <div className="h-full flex flex-col">
                    <SheetHeader className="px-4 py-2 border-b border-zinc-200 dark:border-zinc-700 bg-background dark:bg-background">
                    ...
                    <div className="flex-1 overflow-y-auto px-2 py-2 bg-background dark:bg-background">
                      <SdkDocs formId={id} />
                    </div>
                  </div>
                </SheetContent>
              ...
              <Sheet>
                ...
                <SheetContent side="right" className="w-[80vw] sm:w-[60vw] md:w-[50vw] lg:w-[40vw] xl:w-[30vw] p-0 max-w-screen-md h-screen overflow-hidden">
                  <div className="h-full flex flex-col">
                    <SheetHeader className="px-4 sm:px-4 py-3 sm:py-2 border-b border-zinc-200 dark:border-zinc-700 bg-background dark:bg-background">
                      <SheetTitle className="text-lg sm:text-xl">Form Settings</SheetTitle>
                      <SheetDescription className="text-sm sm:text-base">
                        Manage your form settings and preferences.
                      </SheetDescription>
                    </SheetHeader>
                    <div className="flex-1 overflow-y-auto px-2 sm:px-4 py-3 sm:py-2">
                      <FormSettings 
                        formId={id}  
                        name={name} 
          ...
          <div className="grid grid-cols-2 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-2 xs:gap-3 sm:gap-4">
            <div className="bg-background rounded-lg sm:rounded-xl p-2 xs:p-3 sm:p-4 border border-zinc-200 dark:border-zinc-700/50 hover:border-zinc-200 dark:hover:border-zinc-600/50 transition-all duration-200">
              <div className="flex items-center gap-2 xs:gap-3">
            ...
            <div className="bg-background rounded-lg sm:rounded-xl p-2 xs:p-3 sm:p-4 border border-zinc-200 dark:border-zinc-700/50 hover:border-zinc-200 dark:hover:border-zinc-600/50 transition-all duration-200">
              <div className="flex items-center gap-2 xs:gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs xs:text-sm text-zinc-500 dark:text-zinc-500">Completion Rate</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-background rounded-lg sm:rounded-xl p-2 xs:p-3 sm:p-4 border border-zinc-200 dark:border-zinc-700/50 hover:border-zinc-200 dark:hover:border-zinc-600/50 transition-all duration-200">
              <div className="flex items-center gap-2 xs:gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs xs:text-sm text-zinc-500 dark:text-zinc-500">Avg. Time to Complete</p>
                </div>
              </div>
            </div>
          </div>
