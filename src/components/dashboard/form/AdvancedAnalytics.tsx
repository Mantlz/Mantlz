        ...
        {!hasPremiumAccess && showPaywall ? (
          <Card className="border-zinc-200 dark:border-zinc-800 bg-background dark:bg-background shadow-none w-full rounded-lg sm:rounded-xl">
            <CardHeader className="pb-3 pt-4 px-4 sm:px-5">
              ...
              <CardDescription className="text-center text-zinc-500 dark:text-zinc-400 text-sm sm:text-base">
                Upgrade to Standard or Pro plan to access detailed user insights
              </CardDescription>
            </CardHeader>
            <CardContent className="text-center px-4 sm:px-5 pb-5">
              <div className="space-y-3 mb-4">
                <div className="p-3 sm:p-4  rounded-lg text-sm sm:text-base text-zinc-700 dark:text-zinc-500">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3 sm:p-4 border border-zinc-200 dark:border-zinc-800 rounded-lg text-center">
                    <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-1">Browsers</p>
                  ...
                  <div className="p-3 sm:p-4 border border-zinc-200 dark:border-zinc-800 rounded-lg text-center">
                    <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-1">Locations</p>
          ...
          <Card
            ...
            className=" shadow-none border-zinc-200 bg-background dark:bg-background dark:border-zinc-800 cursor-pointer hover:bg-zinc-50 dark:hover:bg-amber-500/50 transition-all w-full rounded-lg sm:rounded-xl"
          >
            ...
            <CardContent className="text-center px-4 sm:px-5 pb-4">
              <div className="py-2 sm:py-5 flex flex-col items-center">
                ...
                <p className="text-base sm:text-lg font-medium text-zinc-800 dark:text-zinc-500 mb-2">View User Insights</p>
