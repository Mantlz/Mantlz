  ...
  return (
    <div className="flex items-center justify-center h-[70vh]">
      <div className="p-8 text-center max-w-md mx-auto bg-gray-50 dark:bg-zinc-900 rounded-lg border-2 border-dashed border-gray-300 dark:border-zinc-700">
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-lg bg-gray-200 dark:bg-zinc-800 mb-4 border-2 border-gray-300 dark:border-zinc-700">
