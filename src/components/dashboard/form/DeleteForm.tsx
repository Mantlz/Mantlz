    ...
    <>
      ...
      <div className="mt-16 pt-8 border-t border-zinc-200 dark:border-zinc-700">
        <div className="mb-6">
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-500">Irreversible and destructive actions</p>
        </div>
        ...
        <DialogContent className="max-w-lg mx-4 sm:mx-auto">
          <div className="p-6">
            ...
            <div className="mb-6">
              ...
              <DialogDescription className="text-base text-gray-600 dark:text-zinc-500 leading-relaxed">
