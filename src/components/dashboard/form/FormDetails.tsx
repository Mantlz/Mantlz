...
function FormDetails({ formId: propFormId }: FormDetailsProps = {}) {
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center min-h-[400px] w-full  rounded-xl border border-slate-200 dark:border-zinc-800 shadow-md">
  ...
  if (isError || !form) {
    return (
      <div className="min-h-[400px] w-full flex items-center justify-center  rounded-xl border border-red-200 dark:border-red-800/50 shadow-md p-6">
