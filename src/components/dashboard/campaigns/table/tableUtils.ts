...
export async function fetchCampaigns(
  ...
  try {
    ...
    console.log(`Fetching campaigns for form: ${formId} (page ${page}, itemsPerPage ${itemsPerPage})`)
    ...
    if (!campaignsData || !Array.isArray(campaignsData)) {
      console.error(`Invalid campaigns data returned from API for form ${formId}:`, campaignsData)
      return {
        campaigns: [],
        pagination: {
          totalItems: 0,
