...
export function TableContent({
  ...
  return (
    <div className="bg-white dark:bg-background rounded-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden">
                    ...
                    <div className="flex justify-end items-center gap-2">
                      ...
                      {campaign.status === "SCHEDULED" && (
                        <AlertDialog>
                          ...
                          <AlertDialogContent className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg">
                            <AlertDialogHeader>
                              <AlertDialogTitle>
