      ...
      {isOpen && !showUpgradeModal && (
        <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
          <DialogContent className="sm:max-w-[500px] bg-white dark:bg-background border-0 shadow-xl">
            <DialogHeader className="p-6 pb-4 border-b border-gray-100 dark:border-zinc-950/50">
            ...
            <div className="p-6 space-y-5">
              {/* Recipient Info */}
              <div className="bg-gray-50 dark:bg-background/10 rounded-lg p-4 border border-gray-100 dark:border-zinc-950/50">
            ...
            <div className="flex items-center justify-end gap-3 p-6 pt-2 border-t border-gray-100 dark:border-zinc-950/50">
              <Button
                variant="outline"
                onClick={onClose}
