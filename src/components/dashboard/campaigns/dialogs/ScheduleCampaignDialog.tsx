              ...
              {[  
                ...
                <div key={value} 
                  className={cn(
                    ...
                    recipientType === value 
                      ? "bg-amber-50 dark:bg-amber-700/20 border-amber-200 dark:border-amber-800 shadow-sm"
                ...
                <div className="flex items-center gap-3">
                  <div className="relative">
                    <Input
                      ...
                      className="w-28 h-9 text-sm rounded-md border-gray-200 dark:border-zinc-700 focus:ring-amber-500 dark:focus:ring-amber-400 pl-8"
                    />
                    <div className="absolute left-0 top-0 bottom-0 w-8 flex items-center justify-center text-zinc-500">
                      <span>#</span>
                    </div>
                  </div>
                  <div className="flex-1">
          ...
          <div className="p-5 bg-white dark:bg-zinc-800 rounded-b-lg">
            ...
            <div className="mt-4 max-w-md mx-auto">
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      period === p
                        ...
                        : "text-gray-600 dark:text-zinc-500 hover:text-orange-600 dark:hover:text-orange-400"
                    )}
                  >
                    {p}
                  </button>
              ...
              <div className="bg-gray-50 dark:bg-zinc-700 rounded-lg p-3 border border-gray-200 dark:border-zinc-600">
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          isSelected
                            ...
                            : "text-gray-600 dark:text-zinc-500 hover:bg-gray-100 dark:hover:bg-zinc-600 border-transparent hover:border-gray-300 dark:hover:border-zinc-500"
                        )}
                      >
                        {time}
                      </button>
                ...
                <div className="mt-3 px-3 py-2 bg-gray-100 dark:bg-zinc-600 rounded-md text-xs text-zinc-500 dark:text-zinc-500">
              ...
              {date && (
                <div className="mt-4 p-4 rounded-lg border border-orange-200 dark:border-orange-800 bg-gradient-to-r from-orange-50 to-white dark:from-orange-900/20 dark:to-zinc-800">
                  <div className="flex items-start gap-3">
                    <div className="w-8 h-8 rounded-full bg-orange-100 dark:bg-amber-600/40 flex items-center justify-center shrink-0 mt-0.5">
      ...
      <div className="px-5 pt-5 pb-2 bg-white dark:bg-zinc-800 border-b border-gray-100 dark:border-zinc-700">
        <div className="flex items-center justify-between relative">
          ...
          <div className="absolute top-4 left-8 right-8 h-0.5 bg-gray-100 dark:bg-zinc-700 -z-10">
            <div 
              className="h-full bg-amber-500 dark:bg-amber-500 transition-all duration-500 ease-in-out" 
              ...
              <div
                className={cn(
                  ...
                  currentStep === step.number
                    ...
                    : "bg-gray-100 text-zinc-500 dark:bg-zinc-700 dark:text-zinc-500"
                )}
              >
  ...
  return (
    <>
      <Button 
        variant="outline" 
        size="sm" 
        className="h-7 text-md bg-amber-500 text-black/70 dark:text-white dark:border-background border text-sm shadow-md shadow-zinc-950/30 ring ring-inset ring-white/20 transition-[filter] duration-200 hover:brightness-125 active:brightness-95"
          ...
          <DialogContent className="sm:max-w-[450px] p-0 border rounded-xl shadow-xl overflow-hidden">
            <DialogHeader className="p-4 bg-white dark:bg-zinc-800 border-b border-gray-100 dark:border-zinc-700">
              <div className="flex items-center gap-3">
                <div>
                  ...
                  <DialogDescription className="text-xs text-zinc-500 dark:text-zinc-500 mt-0.5">
            ...
            <div className="flex justify-between p-4 border-t border-gray-100 dark:border-zinc-700 bg-white dark:bg-zinc-800">
              ...
              <Button 
                ...
                className="h-9 px-4 text-sm bg-amber-500 hover:bg-amber-600 dark:bg-amber-500 dark:hover:bg-amber-500 text-white rounded-md transition-all duration-200 shadow-md disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1.5"
              >
                {currentStep === 3 
