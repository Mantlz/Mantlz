...
// Colorful theme
<FeedbackForm formId="your-form-id" theme="colorful" />

// Minimal theme
<FeedbackForm formId="your-form-id" theme="minimal" />

// Rounded theme
<FeedbackForm formId="your-form-id" theme="rounded" />

// Glass theme
<FeedbackForm formId="your-form-id" theme="glass" />

// Retro theme
<FeedbackForm formId="your-form-id" theme="retro" />

// Flat theme
<FeedbackForm formId="your-form-id" theme="flat" />
```
