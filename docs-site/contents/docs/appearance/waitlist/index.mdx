...
description: Customize the appearance of your waitlist form
---
...
<WaitlistForm
  ...
  appearance={{
    ...
    // Button styling
    submitButton: 'bg-zinc-600 hover:bg-zinc-700 text-white font-medium',
...
<WaitlistForm
  ...
  appearance={{
    ...
    elements: {
      ...
      submitButton: 'bg-black hover:bg-zinc-800 text-white font-bold uppercase px-6 py-3 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,0.3)]',
...
<WaitlistForm
  ...
  appearance={{
    ...
    container: 'bg-white dark:bg-zinc-900 p-6 rounded-xl shadow-lg',
    
    // Custom border radius and shadow
    card: 'rounded-2xl shadow-xl border border-zinc-200 dark:border-zinc-700',
