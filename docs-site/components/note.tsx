...
export default function Note({
  ...
  const noteClassNames = clsx({
    ...
    "dark:bg-red-950 dark:bg-gradient-to-tr dark:from-red-950 dark:to-red-900/70 bg-red-100 bg-gradient-to-tr from-red-100 to-red-50 border-red-200 dark:border-red-900/50":
      type === "danger",
    "dark:bg-amber-950 dark:bg-gradient-to-tr dark:from-amber-950 dark:to-amber-900/70 bg-amber-100 bg-gradient-to-tr from-amber-100 to-amber-50 border-amber-200 dark:border-amber-900/50":
      type === "warning",
